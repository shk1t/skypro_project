...
def filter_by_currency(transactions: list[dict], currency_code: str) -> Iterator[dict]:
    """
    Итератор, который поочередно выдает транзакции, где code соответствует заданному currency_code
    (например, USD)
    """
...
def card_number_generator(start: int, end: int) -> Iterator[str]:
    ...
    Генерирует в заданном диапазоне от 0000 0000 0000 0001 до 9999 9999 9999 9999.
    """
